...
public class ProductController {
    ...
    public ResponseEntity addProduct(@Valid @RequestPart(name = "product") ProductRequest product, @RequestPart(name = "files", required = false) MultipartFile[] files) throws URISyntaxException {
